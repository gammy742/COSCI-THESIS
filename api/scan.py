...
def process_scan():
    ...
    # Validate booth_id (รองรับ string เช่น "BOOTH_01")
    ...
    try:
        ...
        # หา Booth — query boothnum (string) ก่อน fallback ด้วย id
        cursor.execute("""
        ...
        # เช็คสแกนซ้ำ + FOR UPDATE (ต้องมี BEGIN ก่อน)
